...
<div class="container" style=" width: 40%"><hr/>
    <h1 style="text-align: center">EDIT PROVINCE</h1><hr/>
    <div class="container" >
        <center><?php
    ...
    <?php echo form_open('origin/updateProv');?>
         <input type="hidden" name="provinceID" value="<?php echo $province->id; ?>">

    <div class="form-group row">
      <label for="title" class="col-md-2 text-center">Region</label>
      <div class="col-md-10">
        <input type="text" value="<?php echo $province->province; ?>" name="province" class="form-control" required>
      </div>
    </div>
    <div class="form-group row"> 
